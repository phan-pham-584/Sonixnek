...
/* I2C n Slave Address 1~3 register <I2Cn_SLVADDR1~3> (0x14/0x18/0x1C) */
																								...
																								//ADD[9:0] is valid when ADD_MODE = 1
																								//ADD[7:1] is valid when ADD_MODE = 0																									
#define	I2C_ADDR_SLAVE_ADDR1							0			//The I2C slave address 1
#define	I2C_ADDR_SLAVE_ADDR2							0			//The I2C slave address 2
#define	I2C_ADDR_SLAVE_ADDR3							0			//The I2C slave address 3
#define	I2C_ADDR_SLAVE_ADDR4							0			//The I2C slave address 4
#define	I2C_ADDR_SLAVE_ADDR5							0			//The I2C slave address 5
#define	I2C_ADDR_SLAVE_ADDR6							0			//The I2C slave address 6
#define	I2C_ADDR_SLAVE_ADDR7							0			//The I2C slave address 7
#define	I2C_ADDR_SLAVE_ADDR8							0			//The I2C slave address 8
#define	I2C_ADDR_SLAVE_ADDR9							0			//The I2C slave address 9
...
/* I2C n Setup Time register<I2Cn_SETUPT)> (0x28) */
...
/* I2C n DMA Mode register<I2Cn_DMA)> (0x50) */
																								//[28:28]I2C issues NACK/ACK for last data in RX DMA mode
#define	I2C_RX_DMA_LAST_ACK								0			//I2C issue ACK for last data in RX DMA mode
#define	I2C_RX_DMA_LAST_NACK							1			//I2C issue NACK for last data in RX DMA mode
...
#define	I2C_ACK_FALG		0
#define	I2C_NACK_FALG		1
